...
{
  public class YashaDagger_Missile : Missile
  {
    ...
    {
      DB.drones[MIDROW_OBJECT_NAME] = VionheartScarlet.Instance.TrickDagger_Heavy.Sprite;
    }
    ...
    public override Spr? GetIcon() => new Spr?(VionheartScarlet.Instance.TrickDagger_Heavy_Icon.Sprite);
    ...
    {
      return [new GlossaryTooltip($"{VionheartScarlet.Instance.Package.Manifest.UniqueName}::Midrow::YashaDagger_Missile")
			{
